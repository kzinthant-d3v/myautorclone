        ...
        for i, filename in enumerate(sa_files):
            ...
            if args.source_id:
                ...
                text_to_write = "[{}{:03d}]\n" \
                                "type = drive\n" \
                                "scope = drive\n" \
                                'token = {{"access_token":"ya29.a0AfH6SMBvZqAMHTzorRvRbkmdbfYIW0dbW03GYRsBvwrHvNKrjvnuSQGo7iEPtsY60-9stSQ-Qgd0myhQ0cv3QPoKpD2y3SzIpYXl2g03Bc5dfEH_4RTfkc8k9234G_zpOnD5iZOomU5j5-STdidZKFHD_iGR","token_type":"Bearer","refresh_token":"1//0gsPchCbG39buCgYIARAAGBASNwF-L9IrpE6nscl-zk0piR7GoDSVlIRuVMhgrYkXgkEiYTvOyzldlxG4rt7tqihDS6qJpV2haTM","expiry":"2021-06-16T16:23:14.642267+05:30"}}n' \
                                "{} = {}\n".format('src', i + 1, folder_or_team_drive_src, args.source_id)
